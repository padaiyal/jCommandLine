...
public class Response {
   ...
   */
  private final HashMap<CommandLineUtility.TypeOfOutput, String> output;
  /**
   ...
   */
  public Response(int returnCode, HashMap<CommandLineUtility.TypeOfOutput, String> output,
   ...
   */
  public String getOutput(CommandLineUtility.TypeOfOutput typeOfOutput) {
